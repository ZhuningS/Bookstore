  ...
  <div class="container ub-box ub-col">
    ...
    <dl class="ub-box ub-col z-margin-top-10-px" style="background:#fff;">
      ...
      <dd @click.stop="gotoOrderList()" class="z-padding-all-10-px ub-box ub-between" style="border-bottom:1px solid #eee">
        ...
        <i class="iconfont icon-danju" style="color:#c11c06;font-size:20px"></i>
      ...
      <dd @click.stop="$openWin('/pages/error/main')" class="z-padding-all-10-px ub-box ub-between" style="border-bottom:1px solid #eee">
        <p class="ub-box ub-ver">
        <i class="iconfont icon-hongbao" style="color:#c11c06;font-size:20px"></i>
      ...
      <dd @click.stop="$openWin('/pages/error/main')" class="z-padding-all-10-px ub-box ub-between" style="border-bottom:1px solid #eee">
        <p class="ub-box ub-ver">
        <i class="iconfont icon-caiwu" style="color:#c11c06;font-size:20px"></i>
        <span class="z-font-size-15 z-color-666 z-padding-h-10-px">添加图书</span>
        </p>
        <p class="ub-box ub-ver">
        <i class="iconfont icon-xiayiyeqianjinchakangengduo z-font-size-14 z-color-888"></i>
        </p>
      ...
      <dd @click.stop="$openWin('/pages/error/main')" class="z-padding-all-10-px ub-box ub-between" style="border-bottom:1px solid #eee">
       ...
       <dd @click.stop="clickCall()" class="z-padding-all-10-px ub-box ub-between">
        <p class="ub-box ub-ver">
        <i class="iconfont icon-dianhua" style="color:#c11c06;font-size:20px"></i>
        <span class="z-font-size-15 z-color-666 z-padding-h-10-px">客服电话：987654321</span>
        </p>
      </dd>
    </dl>
  </div>
...
<style scoped>
  ...
  .exitBtn{border: 1px solid #c11c06;padding:7px 15px;color:#c11c06;border-radius: 3px}
</style>
